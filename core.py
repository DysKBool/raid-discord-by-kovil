...
baner = f'''
{y}Comunidade Kovil: {g}https://discord.gg/XjYYdA44pm
{y}Comunidade Kovil: {g}https://discord.gg/XjYYdA44pm
{y}Comunidade Kovil: {g}https://discord.gg/XjYYdA44pm
{y}Comunidade Kovil: {g}https://discord.gg/XjYYdA44pm
{y}Comunidade Kovil: {g}https://discord.gg/XjYYdA44pm
...
[+]Bot in {len(client.guilds)} servers!''')
        ...
        try:
            ...
            if error == '''o BOT Precisa ter Essas Seguintes Funcoes Ativas: PRESENCE INTENT, SERVER MEMBERS INTENT, MESSAGE CONTENT INTENT''':
                input(f'{r}Verifique os Erros\n{g}Visualize -> https://prnt.sc/aUPh4iDHGcqL\n{b}Clique enter para voltar para o menu...')
            else:
                input(f'{r}{error}\n{b}Clique enter para voltar para o menu...')
            continue
    elif choice == '2':
